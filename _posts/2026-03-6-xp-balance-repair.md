...
Like many good projects, this started with a random stranger asking for help on the Internet. In this case, it was seeigecannon posting in the [IoT Hacker Hideout Discord server](https://discord.gg/EJRPfr7Q) about a Mettler Toledo XP Series analytical balance that was throwing a "Program Memory" error. 
